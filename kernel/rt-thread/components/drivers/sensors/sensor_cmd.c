...
static void sensor(int argc, char **argv)
{
    ...
    else if (argc == 3)
    {
        ...
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_RANGE, (void *)atol(argv[2]));
        }
        else if (!strcmp(argv[1], "sm"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_MODE, (void *)atol(argv[2]));
        }
        else if (!strcmp(argv[1], "sp"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_POWER, (void *)atol(argv[2]));
        }
        else if (!strcmp(argv[1], "sodr"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_ODR, (void *)atol(argv[2]));
        }
        else
        {
