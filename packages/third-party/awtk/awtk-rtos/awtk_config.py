...
# AIC PATH
AIC_ROOT         = joinPath(TK_LINUX_FB_ROOT, '../../../luban')
AIC_MPP_DIR      = joinPath(AIC_ROOT, 'source/artinchip/aic-mpp')
AIC_MPP_LIB_DIR  = joinPath(AIC_ROOT, 'output/aic1602_demo100_nand/build/aic-mpp')
...
TSLIB_LIB_DIR=''
TSLIB_INC_DIR=''
TOOLS_PREFIX = '/home/ARTMEM/zequan.liang/luban/output/aic1602_demo100_nand/host/opt/ext-toolchain/bin/riscv64-unknown-linux-gnu-'
...
# AIC Path
  joinPath(AIC_ROOT, 'output/aic1602_demo100_nand/host/riscv64-linux-gnu/sysroot/usr/include'),
  joinPath(AIC_ROOT, 'output/aic1602_demo100_nand/host/riscv64-linux-gnu/sysroot/usr/local/include'),
  joinPath(AIC_ROOT, 'output/aic1602_demo100_nand/host/riscv64-linux-gnu/sysroot/usr/include/video')
  ] + OS_CPPPATH

# AIC LIBPATH
LIBPATH = [
  joinPath(AIC_MPP_LIB_DIR, 'base'),
  joinPath(AIC_MPP_LIB_DIR, 'ge'),
  joinPath(AIC_MPP_LIB_DIR, 've/common'),
  joinPath(AIC_MPP_LIB_DIR, 've/decoder')
] + LIBPATH
