 ...
 * History:
 * ================================================================
 * 2023-9-07 Zequan Liang <zequan.liang@artinchip.com> create
 * 2023-9-14 Zequan Liang <zequan.liang@artinchip.com> docking image decoding
 * 2023-9-23 Zequan Liang <zequan.liang@artinchip.com> optimize fill rect
 * 2023-9-24 Zequan Liang <zequan.liang@artinchip.com> fix bugs caused by stride alignment
 * 2023-10-24 Zequan Liang <zequan.liang@artinchip.com> adapt to rtos platform
 *
 */
