...
#if (defined CONFIG_MAC_USE_UNCACHE_BUF) && ((defined CONFIG_MAC_ZERO_COPY_RXBUF) || (defined CONFIG_MAC_ZERO_COPY_TXBUF))
#define LWIP_PBUF_MEMPOOL(name, num, payload, desc) LWIP_MPPDMA_MEMPOOL(name, num, (LWIP_MEM_ALIGN_SIZE(sizeof(struct pbuf)) + LWIP_MEM_ALIGN_SIZE(payload)), desc)
#else
