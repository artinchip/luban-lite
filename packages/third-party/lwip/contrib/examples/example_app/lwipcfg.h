...
#else
#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), CONFIG_PORT_IP_ADDR0, CONFIG_PORT_IP_ADDR1, CONFIG_PORT_IP_ADDR2, CONFIG_PORT_IP_ADDR3)
#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), CONFIG_PORT_GW_IP_ADDR0, CONFIG_PORT_GW_IP_ADDR1, CONFIG_PORT_GW_IP_ADDR2, CONFIG_PORT_GW_IP_ADDR3)
#define LWIP_PORT_INIT_NETMASK(addr)  IP4_ADDR((addr), CONFIG_PORT_NET_MASK0, CONFIG_PORT_NET_MASK1, CONFIG_PORT_NET_MASK2, CONFIG_PORT_NET_MASK3)
#endif
