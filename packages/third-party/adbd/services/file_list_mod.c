...
#ifdef LPKG_ADB_FILELIST_SUP_MD5
#include <tiny_md5.h>
#endif
...
#if defined(LPKG_ADB_EXTERNAL_MOD_ENABLE) && defined(LPKG_ADB_FILELIST_MOD_ENABLE)
...
#ifdef LPKG_ADB_FILELIST_FULL_PATH
